        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">
                    <input type="button" value="增加" class="btn_add" onclick="location.href='/index.php/IssueCategory/add';" />
                </div>  
...
<?php if(is_array($res['res'])): $i = 0; $__LIST__ = $res['res'];if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <input type="button" value="修改" class="btn_modify" onclick="location.href='/index.php/IssueCategory/edit/id/<?php echo ($vo["id"]); ?>';"/>
                                <input type="button" value="删除" class="btn_delete" onclick="deletes('/index.php/IssueCategory/delete/id/<?php echo ($vo["id"]); ?>');" />
                            </td>
