...
<?php echo jumps($infos['authority'],CONTROLLER_NAME);?>
        ...
        <!--主要区域开始-->
        <div id="main">
            <form action="/index.php/Goods/index.html/upload" method="get" id="search" enctype="multipart/form-data">
                
                <!--查询-->
                <div class="search_add">                        
                    <div>物品ID：<input type="text" class="text_search width130" value="<?php echo I('get.sn');?>" name='sn'/></div>                            
...
<?php if(is_array($res['res'])): $i = 0; $__LIST__ = $res['res'];if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                     ...
                     <!--    <div class="input_info">
                        ...
                        <td> 
                            ...
                            <input type="submit" value="上传" onclick=" location.href='/index.php/Goods/upload " / >
                        </td>
